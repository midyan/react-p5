function sketch(p) {
  ...
  function Planet(){
    ...
    this.gravity = function(sun){
      var vecDist = p.createVector(this.pos.x-sun.pos.x, this.pos.y-sun.pos.y)
      var dist = vecDist.mag()
      var unitVecDist = vecDist.normalize()
      var accModul = unitVecDist.mult(-sun.gravity_factor/(dist*dist))
